...
For the perceptive control architecture, please refer to [legged_perceptive](https://github.com/qiayuanl/legged_perceptive).
...
This project is released under [MIT license](https://github.com/lab-sun/Feetend-Planner/blob/main/LICENSE).

## 👏 Acknowledgements
- [legged_perceptive](https://github.com/qiayuanl/legged_perceptive)
